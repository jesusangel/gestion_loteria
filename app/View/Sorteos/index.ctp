<div class="sorteos index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('precio_x_decimo'); ?></th>
			<th><?php echo $this->Paginator->sort('fecha'); ?></th>
			<th class="actions"><?php echo __('Actions'); ?></th>
	</tr>
	<?php foreach ($sorteos as $sorteo): ?>
	<tr>
		<td><?php echo h($sorteo['Sorteo']['id']); ?>&nbsp;</td>
		<td><?php echo h($sorteo['Sorteo']['numero']); ?>&nbsp;</td>
		<td><?php echo h($sorteo['Sorteo']['anio']); ?>&nbsp;</td>
		<td><?php echo h($sorteo['Sorteo']['precio_x_decimo']); ?>&nbsp;</td>
		<td><?php echo h($sorteo['Sorteo']['fecha']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $sorteo['Sorteo']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $sorteo['Sorteo']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $sorteo['Sorteo']['id']), null, __('Are you sure you want to delete # %s?', $sorteo['Sorteo']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
